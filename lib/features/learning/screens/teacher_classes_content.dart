...
import 'package:kitoapp/features/learning/widgets/edit_lesson_sheet.dart';
...
class _TeacherClassesContentState extends State<TeacherClassesContent> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      TeacherLessonsStoreProvider.of(context).loadFromSupabase();
    });
  }
  ...
  Widget build(BuildContext context) {
    ...
    return ListenableBuilder(
      listenable: store,
      builder: (context, _) {
        if (store.isLoading && store.allLessons.isEmpty) {
                      ...
                      child: lessons.isEmpty
                          ...
                          : ListView.builder(
                              ...
                              itemBuilder: (context, index) {
                                return TeacherLessonTile(
                                  lesson: lessons[index],
                                  onTap: () => showEditLessonSheet(
                                    context,
                                    lessons[index],
                                  ),
                                );
