...
class StudentRecentAnnouncements extends StatelessWidget {
  const StudentRecentAnnouncements({
    super.key,
    this.announcements = const [
      AnnouncementPreview(
        title: 'Sunday Service',
        message: 'Join us this Sunday at 9:00 AM for worship and fellowship.',
        date: 'Jun 15',
      ),
      AnnouncementPreview(
        title: 'Youth Retreat',
        message: 'Registration for the summer youth retreat is now open.',
        date: 'Jun 12',
      ),
      AnnouncementPreview(
        title: 'Quiz Week',
        message: 'Prepare for end-of-term quizzes starting next Monday.',
        date: 'Jun 10',
      ),
    ],
  });
